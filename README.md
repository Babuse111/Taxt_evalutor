...
For any one to run the funtion locally must used python programming language compiler to his/her local machine, and download/copy a function file on my github repo files(https://github.com/Babuse111/Text_evaluator)
